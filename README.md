...
[![Security Status](https://img.shields.io/badge/security-patched-brightgreen)](https://github.com/kshartman/media-management-system/releases/tag/v0.2.7)
...
**All users should update to v0.2.7** to address security vulnerabilities and bug fixes:
