    ...
    helpSections.push({
      ...
      content: (
        <div className="space-y-4">
          ...
          <h3 className="text-lg font-semibold">Deleting Content</h3>
          <p className="text-red-600">
            ⚠️ Use the delete icon (
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="p-3 bg-blue-50 rounded">
              ...
              <p className="text-sm">Can create, edit, and delete media cards. Default role for new accounts.</p>
            </div>
            <div className="p-3 bg-red-50 rounded">
              <h4 className="font-medium">Admin Role</h4>
              <p className="text-sm">Full access including user management. Use carefully!</p>
            </div>
          </div>
