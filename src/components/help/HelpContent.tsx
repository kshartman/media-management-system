        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="p-3 bg-blue-50 rounded">
              ...
              <p className="text-sm">
                Toggle the trash button (
                <svg className="inline h-4 w-4 mx-1 text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                </svg>
                ) in the filter bar to show/hide deleted cards. Deleted cards appear with a gray overlay.
              </p>
            </div>
            <div className="p-3 bg-green-50 rounded">
              <h4 className="font-medium">Restoring Cards</h4>
              <p className="text-sm">
                For deleted cards, click the edit icon to restore them back to active status.
              </p>
            </div>
