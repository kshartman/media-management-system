...
const CardFormNew: React.FC<CardFormProps> = ({ 
  ...
  useEffect(() => {
    if (initialData) {
      ...
      if (type === 'reel' && initialData.preview) {
        ...
        console.log('Preview autogeneration check for reel:', {
          preview: initialData.preview,
          metadata: initialData.fileMetadata,
          hasAutoGeneratedIndicator
        });
        
        setIsPreviewAutogenerated(hasAutoGeneratedIndicator);
  ...
  const handleFileChange = (field: string) => (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      ...
      if (field === 'movie' && type === 'reel') {
        console.log("New movie file selected, preview will be regenerated");
      ...
      if ((field === 'download' && type === 'image') || 
        ...
        if (isPreviewAutogenerated) {
          console.log("Auto-generated preview image will be updated with new source");
          setUploadedFiles(prev => ({
            ...prev,
            preview: null,
            remove_preview: true,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isPreviewAutogenerated) {
        console.log("Setting generatePreview flag to true");
  ...
  const handleRemoveFile = (field: string) => () => {
    ...
    if (field === 'preview') {
      setIsPreviewAutogenerated(true);
      console.log("Preview will be auto-generated after removal");
  ...
  const renderFileInput = (field: string, label: string, accept?: string, isOptional: boolean = false) => {
    ...
    // Debug log for other preview fields
    if (field === 'preview') {
      console.log('Rendering preview field:', {
        type,
            ...
            <MultiImageUploader 
              ...
              onChange={(files) => {
                ...
                if (type === 'social' && 
                    files.length > 0 && 
                    isPreviewAutogenerated) {
                  console.log("Auto-generated preview image will be updated with new first image");
                  setUploadedFiles(prev => ({
                    ...prev,
                    preview: null,
                    remove_preview: true,
