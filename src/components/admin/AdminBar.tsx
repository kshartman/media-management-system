...
const AdminBar: React.FC<AdminBarProps> = ({ onCardCreated, availableTags = [], selectedCardType = 'image', isAdmin = false }) => {
  ...
  return (
    <div className="flex gap-2">
      ...
      {/* User Management Button - Only for Admins, hidden on small screens */}
      {isAdmin && (
